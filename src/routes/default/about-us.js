  ...
  <>
    ...
    >
      <Box sx={{ textAlign: [null, null, 'center', 'left'] }}>
        ...
        >
          ...
          sed do eiusmod tempor incididunt ut labore et doloreut labore et
          dolore magna aliqua. Ut eiusmod tempor incididunt enim ad
          ut&nbsp;aliquip&nbsp;ex&nbsp;ea.
        </Box>
      </Box>
      <Icon
    ...
    <Section sx={{ textAlign: [null, null, 'center'] }}>
      ...
      >
        ...
        model. US practitioners reside across the country. We have a technology
        center in Bengaluru, with scale partners in Mumbai&nbsp;and&nbsp;Mysore.
      </Box>
    </Section>
    ...
    <Section sx={{ textAlign: [null, null, 'center'] }}>
      ...
      >
        ...
        veniam, quis nostrud ut aliquip ex ea.
      </Box>
    </Section>
    <Section
      as="ul"
      ...
      >
        <Box>
          ...
          <Box as="p" sx={{ color: 'text.subtle', lineHeight: 2, mt: 4 }}>
            ...
            experience for their customers. The combination of our firms ensure
            continuous innovation across user experience, administration and
            data leverage. The result is a functionally rich and technically
      ...
      >
        ...
        <Box>
          ...
          <Box as="p" sx={{ color: 'text.subtle', lineHeight: 2, mt: 4 }}>
            ...
            on driving results in the industry. West Monroe Partners provides
            business domain experts to augment Spraoi&rsquo;s next generation
